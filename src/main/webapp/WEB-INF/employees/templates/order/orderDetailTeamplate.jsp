...
<%@page import="Models.OrderStatusHistory"%>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-[20px]">
                ...
                <%
                    ...
                    if (detailse != null && !detailse.isEmpty()) {
                        shippingAddr = detailse.get(0).getAddress();
                    }
                %>
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
                    <div class="space-y-4">
            ...
            <%
                ...
                String[] stepDescs = {
                    ...
                    "The order has been delivered to the carrier.",
            ...
            <div class="mb-8">
                <div class="relative">
                    ...
                    <div class="grid grid-cols-[48px_1fr] gap-x-6">
                        ...
                        <%
                            boolean isDeliveredStep = stepKeys[i].equalsIgnoreCase("Delivered");
                            boolean greenCircle = completed || (current && isDeliveredStep);
                            boolean blueCircle = current && !isDeliveredStep;
                        %>
                        ...
                        <div class="flex items-start">
                            <div class="w-full bg-white rounded-2xl p-6 shadow-md border border-gray-200
                                 transition-shadow duration-300 hover:shadow-lg mb-[13px]
                                 <%= current
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    <h3 class="text-base font-semibold
                                        <%= completed
                                                ? "text-green-700"
                                                : current && stepKeys[i].equalsIgnoreCase("Delivered")
                                                ? "text-green-700"
                                                : current
                                                        ? "text-indigo-700"
                                                        : "text-gray-700"%>">
                                    ...
                                    <div class="flex items-center gap-1">
                                        ...
                                        <span>
                                            Created: <%= order.getCreatedAt() != null
                                                    ? order.getCreatedAt().format(java.time.format.DateTimeFormatter.ofPattern("HH:mm dd-MM-yyyy"))
                                                    : ""%>
                                                by <b><%= order.getCustomer() != null
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-all duration-200">
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-lg text-sm font-mono font-semibold
                              bg-gradient-to-r from-purple-100 to-pink-100 text-purple-800 border border-purple-200
                              break-all">     <%= order.getVoucher().getCode()%>
                        </span>
                    ...
                    <div class="w-80 space-y-4">
                        ...
                        <%
                            boolean hasVoucher = order.getVoucher() != null
                                    && order.getVoucher().getCode() != null
                                    && !order.getVoucher().getCode().trim().isEmpty();
                        %>
                        <% if (hasVoucher) {%>
                        <div class="flex justify-between items-center py-2 border-b border-gray-100">
