...
<html lang="en">
    <head>
        ...
        <title>Staff Login - Nano Forge</title>
    ...
    <body>
        <div class="relative min-h-screen bg-white">
            ...
            <div class="flex items-center justify-center min-h-screen px-4">
                <div class="w-full max-w-md bg-white bg-opacity-90 backdrop-blur-md rounded-2xl shadow-2xl p-8">
                    <div class="text-center mb-6">
                        <h1 class="text-2xl font-bold text-gray-800">Login for Staff</h1>
                    </div>
                    ...
                    <form id="loginForm" method="post" action="${pageContext.request.contextPath}/staff/auth/login">
                        ...
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <a href="${pageContext.request.contextPath}/forget" class="text-sm text-blue-500 hover:underline">Forgot password?</a>
                        </div>

                        <button type="submit"
                                class="w-full py-3 text-white font-semibold rounded-lg bg-gradient-to-r from-pink-500 to-red-400 hover:from-pink-600 hover:to-red-500 transition-all">
                            Log In
                        </button>
