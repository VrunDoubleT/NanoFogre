...
<div class="bg-gray-100">
    <div class="w-[1120px] mx-auto h-[90vh] flex flex-col bg-white shadow-2xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r flex justify-between from-blue-600 to-purple-600 px-8 py-3">
            <h1 class="text-3xl font-bold text-white mb-2">Create New Staff</h1>
                            ...
                            <div class="bg-gray-50 rounded-xl p-6">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input placeholder="Enter name" type="text" name="name" id="name" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none">
                                        <span id="nameError"></span>
                                    </div>

                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                                        <input placeholder="Enter email address" type="text" name="email" id="email" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none">
                                        <span id="emailError"></span>
                                    </div>

                                    <div>
                                        <label for="password" class="block text-sm font-medium text-gray-700 mb-2">Password</label>
                                        <input type="text" id="password" name="password" class="w-full px-4 py-3 bg-gray-100 border-2 border-gray-200 rounded-lg text-gray-600 cursor-not-allowed" placeholder="Password will be created automatically" readonly/>
                                        <div id="generatedPassword" class="hidden mt-3 p-3 bg-slate-50 border border-slate-200 rounded-lg">
                                            <p class="text-sm text-gray-600 mb-1">Generated Password:</p>
                                            <code class="font-mono text-sm font-semibold text-slate-800 break-all" id="passwordDisplay"></code>
                                        </div>
                                    ...
                                    <div class="bg-yellow-50 rounded-xl p-6 border border-yellow-100">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="destroy" class="ml-2 text-sm font-medium text-gray-700">Mark as blocked</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
