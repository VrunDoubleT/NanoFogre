...
public class ForgetDAO extends DB.DBContext {
    ...
    /**
     * Xác nhận reset mật khẩu: ghi mật khẩu mới vào trường chính và xóa trường tạm
     */
    ...
    /**
     * Kiểm tra mã (chưa xác thực, chưa hết hạn) trong bảng VerifyCodes với userType = 0
     */
