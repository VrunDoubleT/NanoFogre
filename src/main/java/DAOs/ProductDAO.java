...
public class ProductDAO extends DB.DBContext {
    ...
    private Product extractProductFromResultSet(ResultSet rs) throws SQLException {
        ...
        product.setBrand(new Brand(brandId, "Brand", null));
        product.setCategory(new Category(categoryId, "Category"));

        ResultSet urlsResult = execSelectQuery(
                "SELECT TOP 1 url FROM ProductImages WHERE productId = ?",
